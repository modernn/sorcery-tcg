...
export function validateCardDefinition(card: GameCardDefinition, path: string): void {
  ...
  if (card.cardType === 'artifact') {
    ...
    if (card.sacrificeThisToGainControlOfTargetEnemyMinionHereUntilBearerLeaves !== undefined
      ...
      throw new RangeError(
        `${path}.sacrificeThisToGainControlOfTargetEnemyMinionHereUntilBearerLeaves must be true`,
      );
    }
  ...
  if (card.cardType === 'magic') {
    ...
    if (card.allyStrikesEachEnemyAtItsLocation !== undefined && card.allyStrikesEachEnemyAtItsLocation !== true) {
      throw new RangeError(`${path}.allyStrikesEachEnemyAtItsLocation must be true when defined`);
    }
    ...
    if (card.grantAirborneToAllyThisTurnThenDrawSpell !== undefined
      && card.grantAirborneToAllyThisTurnThenDrawSpell !== true) {
      throw new RangeError(
        `${path}.grantAirborneToAllyThisTurnThenDrawSpell must be true when defined`,
      );
    }
    ...
    if (card.grantDoubleDamageToAllyNextStrikeThisTurn !== undefined
      && card.grantDoubleDamageToAllyNextStrikeThisTurn !== true) {
      throw new RangeError(
        `${path}.grantDoubleDamageToAllyNextStrikeThisTurn must be true when defined`,
      );
    }
    ...
    if (card.grantLethalToAllyThisTurnThenDrawSpell !== undefined
    ...
    if (card.grantStealthToAlliedMinionsThenDrawSpell !== undefined
    ...
    if (card.grantPowerTwoToAllyThisTurnThenDrawSpell !== undefined
      && card.grantPowerTwoToAllyThisTurnThenDrawSpell !== true) {
      throw new RangeError(
        `${path}.grantPowerTwoToAllyThisTurnThenDrawSpell must be true when defined`,
      );
    }
    ...
    if (card.wardEachAlliedMinionAtTargetWaterSite !== undefined
      && card.wardEachAlliedMinionAtTargetWaterSite !== true) {
      throw new RangeError(`${path}.wardEachAlliedMinionAtTargetWaterSite must be true when defined`);
    }
    ...
    if (card.destroyArtifactsAndAurasAtLocationWithinTwoSteps !== undefined
    ...
    if (card.destroyMinionsAtWaterSiteWithinTwoSteps !== undefined
    ...
    const effectCount = Number(card.burrowAllMinionsAndArtifactsAtTargetLandSite === true)
      ...
      + Number(card.grantAirborneToAllyThisTurnThenDrawSpell === true)
      + Number(card.grantChargeToAllyThisTurn === true)
      + Number(card.grantDoubleDamageToAllyNextStrikeThisTurn === true)
                  ...
                  : card.bearerControllerChoosesExtraRandomOutcome === true
                    ...
                    : card.grantsBearerPower === 2
                      ...
                      : card.grantsBearerLethal === true
                        ...
                        : card.sacrificeThisToGainControlOfTargetEnemyMinionHereUntilBearerLeaves
                          === true
                          ? {
                            sacrificeThisToGainControlOfTargetEnemyMinionHereUntilBearerLeaves:
                              true as const,
            ...
            ? {
              ...
              ...(card.effectProgram !== undefined
                ...
                : card.damageTargetUnit !== undefined
                  ...
                  : card.grantAirborneToAllyThisTurnThenDrawSpell === true
                    ? { grantAirborneToAllyThisTurnThenDrawSpell: true as const }
                  : card.grantChargeToAllyThisTurn === true
                    ? { grantChargeToAllyThisTurn: true as const }
                  : card.grantDoubleDamageToAllyNextStrikeThisTurn === true
                    ? { grantDoubleDamageToAllyNextStrikeThisTurn: true as const }
                  : card.grantFirstStrikeToAllyThisTurn === true

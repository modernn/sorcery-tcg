...
- Movement +1 and +2 use engine-issued explicit surface paths for both Move and Attack and Defend, including exact bounded paths and legal returning routes; sideways-only basic movement excludes forward, backward, and diagonal steps from both actions.
...
- `pnpm verify`: 227 passing public tests at this checkpoint.

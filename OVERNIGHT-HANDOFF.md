...
Canonical line: `master` @ `ffab7f4`. Lanes through `RULE-CATALOG-0508` are merged. TypeScript admits 2×2 token/wrap/outer-column (`0371`–`0376`); 2×2 Landbound now composes with partial and full Flood (`0507`–`0508`). Branch new Phase 3 work as `cursor/<one-family>-0005` from here. Do not grow already-merged landings.

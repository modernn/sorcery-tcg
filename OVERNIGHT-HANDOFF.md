...
`magic_rules.rs` still hosts **19** catalog entries awaiting dedicated backfill (iteration 14 repointed `0019`, `0041`, `0043`, and `0146`; iteration 13 repointed `0057`, `0147`, `0161`, and `0236`; iteration 12 repointed 23 legacy low-ID entries; iteration 11 repointed 16).
...
None. Phase 3 iteration 14 (burrow-legacy/rescue-legacy/mesmerism-legacy/early-harness proofs plus `0019`/`0041`/`0043`/`0146` repoints) landed 2026-09-16 on canonical.

## Next exact step

1. Continue `magic_rules.rs` backfill — **19** rows remain, all low-ID. Suggested iteration 15 four-lane batch: `token-spellcaster-harness` (`0014`, `0018`), `combat-pipeline` (`0020`–`0022` Duel/Leap Attack), `area-targeting-magic` (`0023`–`0027`, `0029`–`0033` region filter/Lash/Freeze/Lightning/Minor Explosion/Chain/Rain/Charge/Overpower), and `burrow-drown-heal-legacy` (`0042`, `0044`–`0046`). Re-spawn as `cursor/<slug>-0005` from canonical @ `a962f7a`.

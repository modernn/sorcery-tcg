...
`data/rules/catalog.json`: **208 rust-supported / 0 typescript-supported** out of 208.

Latest catalog proofs: standalone destroy-site Magic (`RULE-CATALOG-0207`–`0208`).

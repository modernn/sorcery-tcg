...
Canonical line: `master` @ `7a097b2`. Lanes through `RULE-CATALOG-0516` are merged. TypeScript admits 2×2 token/wrap/outer-column (`0371`–`0376`); 2×2 Landbound composes with Flood and Drought (`0507`–`0508`, `0511`); 2×2 Waterbound composes with Drought and Flood (`0509`–`0510`, `0512`); this-turn and stealth-bound enemy-minion control are bound (`0513`–`0516`). Branch new Phase 3 work as `cursor/<one-family>-0005` from here. Do not grow already-merged landings.

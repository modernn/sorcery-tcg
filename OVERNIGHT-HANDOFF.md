...
Canonical line: `master` @ `dedf188`. Lanes through `RULE-CATALOG-0384` are merged (2×2 token/wrap/outer-column/deck-pair, oversized start-turn random teleport, and full token Genesis including adjacent-damage choice). Branch new Phase 3 work as `cursor/<one-family>-0005` from here. Do not grow already-merged landings.

...
`data/rules/catalog.json`: **263 rust-supported / 0 typescript-supported** out of 263.

Latest catalog proofs: end-of-each-turn wandering Aura (`RULE-CATALOG-0262`–`0263`).
...
- `tests/engine` + catalog proofs — 243 engine + 1 catalog pass, including catalog 0167–0263.

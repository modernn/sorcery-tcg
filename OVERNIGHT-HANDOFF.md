...
`data/rules/catalog.json`: **261 rust-supported / 0 typescript-supported** out of 261.

Latest catalog proofs: start-of-controller-turn controller life loss (`RULE-CATALOG-0260`–`0261`).
...
- `tests/engine` + catalog proofs — 242 engine + 1 catalog pass, including catalog 0167–0261.

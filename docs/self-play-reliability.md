...
- Rust has direct proofs for 137 of 161 cataloged scenarios. The remaining mechanics must be ported
  or rejected at manifest admission before their games can affect training.
- Realm Artifacts are admitted only as power Artifacts, Lethal Artifacts, the Siege Ballista, the
  Payload Trebuchet, and the Rolling Boulder. The remaining ability and life-loss Artifacts, plus
  any manifest that pairs an Artifact with burrow Magic or an oversized minion, still fail closed
  at admission.

...
//! RULE-CATALOG-0991, RULE-CATALOG-1000).
...
fn rule_catalog_0978_defending_first_strike_deathrite_pauses_order_and_resumes_once() {
    let deathrite = minion(json!({
        "attack": 2,
        "deathriteDamageEachUnitHere": 1,
        "defense": 3,
...
fn rule_catalog_1000_printed_first_strike_attacking_deathrite_pauses_order_and_resumes_once() {
    let deathrite = minion(json!({
        "attack": 2,
        "deathriteDamageEachUnitHere": 1,
        "defense": 3,
